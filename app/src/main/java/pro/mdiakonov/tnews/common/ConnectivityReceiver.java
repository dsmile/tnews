package pro.mdiakonov.tnews.common;
...
public class ConnectivityReceiver extends BroadcastReceiver{
    ...
    public ConnectivityReceiver(ConnectivityListener connectivityListener, Context context){
    ...
    public void onReceive(Context context, Intent intent) {
        final boolean newState = isConnected(context);
        if (newState != mIsConnected) {
            mIsConnected = newState;
            if (mIsConnected) {
